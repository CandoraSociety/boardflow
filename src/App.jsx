...
import { fetchBrandingConfig, applyBrandingColors } from '@/lib/branding';

const AuthenticatedApp = () => {
  const { isLoadingAuth, isLoadingPublicSettings, authError, navigateToLogin } = useAuth();

  useEffect(() => {
    fetchBrandingConfig().then(branding => {
      if (branding) {
        applyBrandingColors(branding.primaryColor, branding.secondaryColor);
      }
    });
  }, []);
